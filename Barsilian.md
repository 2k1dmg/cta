...
Maybe the "â ê î ô û" letters. The letters "â ê î ô û" are only used to indicate the consonant before this letters is palatalized. They are needed only for dictionaries, educational, technical literature and the like. If there are words in these letters, then they are considered exceptions. They are not used in ordinary texts.     
