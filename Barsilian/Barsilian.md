...
And also names and surnames should be on it. Surnames can end with the letters: ~~"olu",~~ "lī, li" eng. "li/ly", "i". This letter is added in order not to be confused with the same words as the surname. And words can be used as a name.
