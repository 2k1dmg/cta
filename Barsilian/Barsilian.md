...
Tatars, in my opinion, is a collective name for many peoples. And the self-name "Barsilians" was chosen because it is less conflicting since no one claims to it. For example Bulgars.  
...
Since it will be difficult for most people to know the main language of the country, their own and English, therefore *English is chosen as the main* one. But all names, all terms should be taken from the Turkic-Barsil language.
