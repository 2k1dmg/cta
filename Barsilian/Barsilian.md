...
And also names and surnames should be on it. Surnames can end with the letters: ~~"olu",~~ "can" eng. "jan","cī, ci" eng. "ji(jy)", "lī, li" eng. "li/ly", "i"; doubling the last consonant in a word and if there is no vowel then ends in "i"; doubling the last consonant in a word and if there is no vowel then ends in "e". This letter is added in order not to be confused with the same words as the surname. And words can be used as a name.
