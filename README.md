...
Or just use one of these "**Í í, Ì ì, Ĭ ĭ, Î î, Ǐ ǐ, Ïï, Ĩĩ, Į į, Ī ī**" or "**Ý ý Ỳ ỳ Ŷ ŷ Ÿ ÿ Ỹ ỹ Ẏ ẏ Ȳ ȳ Ỷ ỷ Ỵ ỵ Ɏ ɏ Ƴ ƴ Ỿ ỿ**" or "**Ƽ ƽ Ƨ ƨ Ƅ ƅ Ɣ ɣ Ƕ ƕ Ƣ ƣ**" and not replace anything. "**Ī ī**" can be replaced for example by "**Ì ì**" or "**Ỿ ỿ**" or "**Ƨ ƨ**" if it looks better in the text.
